    ...
    void Update()
    {
        ...
        switch (castType)
        {
            case PhysicsType.BoxSingle:
                Physics.BoxCast(startPoint, Vector3.one * 2, angle, transform.up, distance, preview, drawDuration, hitColor, noHitColor);
                break;
            case PhysicsType.BoxAll:
                Physics.BoxCastAll(startPoint, Vector3.one, angle, transform.up, distance, preview, drawDuration, hitColor, noHitColor);
                break;
            case PhysicsType.BoxNonAlloc:
                Physics.BoxCastNonAlloc(startPoint, Vector3.one, angle, transform.up, results, distance, preview, drawDuration, hitColor, noHitColor);
                break;

            case PhysicsType.CapsuleSingle:
                Physics.CapsuleCast(startPoint, new Vector2(1, 2), CapsuleDirection2D.Vertical, angle, transform.up, distance, preview, drawDuration, hitColor, noHitColor); ;
                break;
            case PhysicsType.CapsuleAll:
                Physics.CapsuleCastAll(startPoint, new Vector2(1, 2), CapsuleDirection2D.Vertical, angle, transform.up, distance, preview, drawDuration, hitColor, noHitColor);
                break;
            case PhysicsType.CapsuleNonAlloc:
                Physics.CapsuleCastNonAlloc(startPoint, new Vector2(1, 2), CapsuleDirection2D.Vertical, angle, transform.up, results, distance, preview, drawDuration, hitColor, noHitColor);
                break;

            case PhysicsType.CircleSingle:
                Physics.CircleCast(startPoint, 1, transform.up, distance, preview, drawDuration, hitColor, noHitColor);
                break;
            case PhysicsType.CircleAll:
                Physics.CircleCastAll(startPoint, 1, transform.up, distance, preview, drawDuration, hitColor, noHitColor);
                break;
            case PhysicsType.CircleNonAlloc:
                Physics.CircleCastNonAlloc(startPoint, 1, transform.up, results, preview, drawDuration, hitColor, noHitColor);
                break;
            ...
            case PhysicsType.OverlapCapsule:
                Physics.OverlapCapsule(startPoint, new Vector2(3, 6), CapsuleDirection2D.Vertical, angle, preview, drawDuration, hitColor, noHitColor);
                break;
            case PhysicsType.OverlapCapsuleAll:
                Physics.OverlapCapsuleAll(startPoint, new Vector2(3, 6), CapsuleDirection2D.Vertical, angle, preview, drawDuration, hitColor, noHitColor);
                break;
            case PhysicsType.OverlapCapsuleNonAlloc:
                Physics.OverlapCapsuleNonAlloc(startPoint, new Vector2(3, 6), CapsuleDirection2D.Vertical, angle, colliderResults, preview, drawDuration, hitColor, noHitColor);
                break;
